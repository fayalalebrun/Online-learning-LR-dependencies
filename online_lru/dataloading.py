...
def create_lra_imdb_classification_dataset(
    ...
    from online_lru.dataloaders.lra import IMDB
...
def create_lra_listops_classification_dataset(
    ...
    from online_lru.dataloaders.lra import ListOps
...
def create_lra_path32_classification_dataset(
    ...
    from online_lru.dataloaders.lra import PathFinder
...
def create_lra_image_classification_dataset(
    ...
    print("[*] Generating LRA-cifar Classification Dataset")
    from online_lru.dataloaders.basic import CIFAR10
...
def create_lra_aan_classification_dataset(
    ...
    from online_lru.dataloaders.lra import AAN
...
def create_mnist_classification_dataset(
    ...
    print("[*] Generating MNIST Classification Dataset")
    from online_lru.dataloaders.basic import MNIST
...
def create_copy_pad_classification_dataset(
    ...
    print("[*] Generating padded copy task")
    from online_lru.dataloaders.copy import CopyTask
...
def create_enwik9_dataset(
    ...
    from online_lru.dataloaders.wiki import create_enwik9_dataloader

    in_dim = n_classes = 256
    train_size = 0.9 * 900000000 if train_samples is None else train_samples
    trainloader = create_enwik9_dataloader(bsz, seq_len, train_samples, "train", seed)
    valloader = create_enwik9_dataloader(bsz, seq_len, None, "valid", seed)
    testloader = create_enwik9_dataloader(bsz, seq_len, None, "test", seed)
...
Datasets = {
    ...
    # Copy task
    "copy-pad-classification": create_copy_pad_classification_dataset,
    # enwik9
    "enwik9": create_enwik9_dataset,
}
